...
El PCA es una técnica de reducción de un sistema de múltiples variables a uno más sismple con coordinadas distintas. Las variables nuevan se obtienen operando las originales. Suele utilizarse como parte del **análisis exploratorio de los datos**.
...
![](http://www.sthda.com/sthda/RDoc/images/dbscan-idea.png) Como se ilustra en la figura anterior, los clústeres son regiones densas en el espacio de datos, separadas por regiones de menor densidad de puntos. En otras palabras, la densidad de puntos en un grupo es considerablemente mayor que la densidad de puntos fuera del cluster (“áreas de ruido”).
